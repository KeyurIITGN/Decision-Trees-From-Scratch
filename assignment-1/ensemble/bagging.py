...
class BaggingClassifier():
	def __init__(self, base_estimator, n_estimators=100):
		...
		for j in range(n_estimators):
			self.models.append(base_estimator(criterion='entropy'))
	...
	def plot(self):
		...
		if self.X.shape[1]==2:
			return self.plot_combined_surface()
		return 0,0
	...
	def plot_combined_surface(self):
		...
		plt.axis("tight")
		plt.savefig('Bagging_estimators.png')
		...
		#plt.savefig('Bagging_combined_surfaces.png')
		plt.show()
