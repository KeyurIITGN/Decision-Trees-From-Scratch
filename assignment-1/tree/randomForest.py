...
class RandomForestClassifier():
    ...
    def fit(self, X, y):
        ...
        for i in range(self.n_estimators):
            ...
            if (X.shape[1]<=2):
                ...
                curr_X = X.sample(int(np.random.randint(low=2,high=X.shape[1])),axis=1)
            self.attributes.append(curr_X.columns)
    ...
    def predict(self, X):
        ...
        return pd.Series(final_prediction)
    ...
    def plot_combined_surface(self):
        ...
        for i in range(self.n_estimators):
            ...
            X,y = self.training[i]
            plt.subplot(4,3,i+1)		# decision boundary
        ...
        plt.axis("tight")
        plt.savefig('random_forest_individual.png')
        ...
        plt.savefig('Random_forest_tree_structure.png')
        plt.show()
